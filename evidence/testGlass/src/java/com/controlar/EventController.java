...
public class EventController implements Serializable {
    ...
    @EJB
    private com.controlar.EventFacade ejbFacade;
    ...
    public Event getSelected() {
        if (current == null) {
            current = new Event();
            current.setEventPK(new com.controlar.EventPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Event getEvent(com.controlar.EventPK id) {
    ...
    public static class EventControllerConverter implements Converter {
        ...
        com.controlar.EventPK getKey(String value) {
            com.controlar.EventPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.controlar.EventPK();
            key.setDb(values[0]);
            key.setName(values[1]);
            return key;
        }

        String getStringKey(com.controlar.EventPK value) {
